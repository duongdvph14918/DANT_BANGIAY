...
import com.fourmen.controller.CustomOAuth2UserService;
import com.fourmen.secutity.services.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/admin", "/admin/4MEN","/assets/admin/main/homeAdmin.html").access("hasAnyRole('ROLE_USER', 'ROLE_ADMIN')");
