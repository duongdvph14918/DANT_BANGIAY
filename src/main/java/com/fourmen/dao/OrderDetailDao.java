...
import com.fourmen.entity.ReportProduct;
import com.fourmen.entity.ReportQuantityProduct;
...
//			+"						where o.order.sdtNn is not null and o.order.address is not null and o.order.tenNn is not null and o.order.paymentStatus = 1 and o.order.status =4  "
...
//			+"						where b.order.sdtNn is not null and b.order.address is not null and b.order.tenNn is not null and b.order.paymentStatus = 1 and b.order.status =4 "
...
//			+ "						join Brand d on a.brand.brandId = d.brandId\r\n"
//			+ "						join ShoeType e on e.shoeTypeId = a.shoeType.shoeTypeId\r\n"
//			+ "						where b.order.status != 0 and b.order.sdtNn is not null and b.order.address is not null and b.order.tenNn is not null and b.order.paymentStatus = 1 and b.order.status =4 "	
//			+ "						GROUP BY a.productId,a.name, d.name,e.name"
