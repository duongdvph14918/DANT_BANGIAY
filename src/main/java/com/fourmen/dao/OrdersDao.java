...
import com.fourmen.dto.ThongKeDto;
import com.fourmen.entity.DashBoard;
import com.fourmen.entity.Orders;
import com.fourmen.entity.ReportAccount;
...
//			+ "						join ShoeType e on e.shoeTypeId = a.shoeType.shoeTypeId\r\n"
//			+ "						where MONTH(c.createDate) =?1 and  YEAR(c.createDate) = ?2 and e.shoeTypeId = ?3 and d.brandId = ?4 \r\n"
//			+"						and b.order.status= 4 and b.order.paymentStatus = 1 and b.order.sdtNn is not null and b.order.address is not null and b.order.tenNn is not null "
...
//			+ "						join Brand d on a.brand.brandId = d.brandId\r\n"
//			+ "						join ShoeType e on e.shoeTypeId = a.shoeType.shoeTypeId\r\n"
//			+ "						where e.shoeTypeId = ?1 and d.brandId = ?2 \r\n"
//			+"						and b.order.status= 4 and b.order.paymentStatus = 1 and b.order.sdtNn is not null and b.order.address is not null and b.order.tenNn is not null "
//			+ "						GROUP BY a.productId,a.name, d.name,e.name")
...
//			+ "						join Brand d on a.brand.brandId = d.brandId\r\n"
//			+ "						join ShoeType e on e.shoeTypeId = a.shoeType.shoeTypeId\r\n"
//			+ "						where MONTH(c.createDate) =?1 and YEAR(c.createDate) = ?2 and e.shoeTypeId = ?3 \r\n"
//			+"						and b.order.status= 4 and b.order.paymentStatus = 1 and b.order.sdtNn is not null and b.order.address is not null and b.order.tenNn is not null "
//			+ "						GROUP BY a.productId,a.name, d.name,e.name")
...
//			+ "join shoeType c on c.shoeType_id = p.shoeType_id\r\n"
//			+ "where sdt_nn is not null and ten_nn is not null and address is not null and MONTH(o.create_date) =?1 and  YEAR(o.create_date) = ?2 and c.shoeType_id = ?3 and b.brand_id = ?4",nativeQuery = true)
...
//			+ "join brand b on p.brand_id = b.brand_id\r\n"
//			+ "join shoeType c on c.shoeType_id = p.shoeType_id\r\n"
//			+ "where sdt_nn is not null and ten_nn is not null and address is not null and c.shoeType_id = ?1 and b.brand_id = ?2",nativeQuery = true)
...
//			+ "join brand b on p.brand_id = b.brand_id\r\n"
//			+ "join shoeType c on c.shoeType_id = p.shoeType_id\r\n"
//			+ "where sdt_nn is not null and ten_nn is not null and address is not null and MONTH(o.create_date) =?1 and  YEAR(o.create_date) = ?2 and c.shoeType_id = ?3",nativeQuery = true)
...
//			+ "join brand b on p.brand_id = b.brand_id\r\n"
//			+ "join shoeType c on c.shoeType_id = p.shoeType_id\r\n"
//			+ "where sdt_nn is not null and ten_nn is not null and address is not null and c.shoeType_id = ?1",nativeQuery = true)
...
//			+ "			and MONTH(o.create_date) =?1 and  YEAR(o.create_date) = ?2 and c.shoeType_id = ?3 and b.brand_id = ?4",nativeQuery = true)
...
//			+ "			join shoeType c on c.shoeType_id = p.shoeType_id\r\n"
//			+ "			where o.status ='4' and o.tthai_thanh_toan ='1' \r\n"
//			+ "			and c.shoeType_id = ?1 and b.brand_id = ?2",nativeQuery = true)
...
//			+ "			join shoeType c on c.shoeType_id = p.shoeType_id\r\n"
//			+ "			where o.status ='4' and o.tthai_thanh_toan ='1' \r\n"
//			+ "			and MONTH(o.create_date) =?1 and  YEAR(o.create_date) = ?2 and c.shoeType_id = ?3",nativeQuery = true)
...
//			+ "			join shoeType c on c.shoeType_id = p.shoeType_id\r\n"
//			+ "			where o.status ='4' and o.tthai_thanh_toan ='1' \r\n"
//			+ "			and c.shoeType_id = ?1 ",nativeQuery = true)
