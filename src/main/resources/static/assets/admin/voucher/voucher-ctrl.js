app.controller("voucher-ctrl", function($scope, $http) {
	...
	$scope.luu = function() { 
		...
		var voucherId1 = document.getElementById("voucherId").value;
		if(voucherId1.trim() == "" || voucherId1 == null){
